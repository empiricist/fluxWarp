...
//                player.lastFoodLevel = -1;
            ...
            */
            ...
            if( origin.provider.getDimensionId() != destDim) {
                ...
                WorldServer worldserver1 = minecraftserver.worldServerForDimension(destDim);
                ...
                minecraftserver.getConfigurationManager().transferEntityToWorld(entity, i, worldserver, worldserver1, new WarpCoreTeleporter(worldserver1));
                //entity.worldObj.theProfiler.endStartSection("reloading");
                Entity entityNew = EntityList.createEntityByName(EntityList.getEntityString(entity), worldserver1);
                ...
                if (entityNew != null)
                {
                    ...
                    if (i == 1 && destDim == 1)
                    {
                        BlockPos blockpos = entity.worldObj.getTopSolidOrLiquidBlock(worldserver1.getSpawnPoint());
                        entityNew.moveToBlockPosAndAngles(blockpos, entityNew.rotationYaw, entityNew.rotationPitch);
                    }

                    worldserver1.spawnEntityInWorld(entityNew);
                }
        ...
        LogHelper.info("    Moved entity to x:" + entity.posX + ", y:" + entity.posY + ", z:" + entity.posZ + " and dimension:" + entity.dimension);
        return true;
    }
