package com.empiricist.teleflux.handler;
...
*/
    ...
    private static void loadConfiguration(){
        ...
        maxSize = configuration.getInt("maxSize", Configuration.CATEGORY_GENERAL, 600000, 0, Integer.MAX_VALUE, "Maximum volume for warp region");

        useEnergy = configuration.getBoolean("useEnergy", Configuration.CATEGORY_GENERAL, true, "Whether to use energy at all");
